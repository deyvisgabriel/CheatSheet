...
In this walkthrough, we'll leverage an authenticated file upload exploit and an MS09\_050 exploit against the ManageEngine application running on this Windows-based target.
